...
export class RolesStack extends cdk.Stack {
    ...
    private getEcrGlobalPolicy(): void {
        ...
        const s3UploadBucket = new s3.Bucket( this, 'lambda-test-bitbucket-s3-upload-artifacts-bucket', {
            versioned: true,
        ...
        new cdk.CfnOutput( this, "bitbucketRole", {
            ...
            exportName: 'lambda-test-bitbucket-role'
        });
        ...
        new cdk.CfnOutput( this, "bitbucketS3Bucket", {
            ...
            exportName: 'lambda-test-bitbucket-s3-upload-artifacts-bucket'
        });
    }
    ...
    private createBitBucketUser(): void {
        ...
        new cdk.CfnOutput( this, "userName", {
            ...
            exportName: 'lambda-test-bitbucket-user'
        });
    }
    ...
    private createPipelineinfra(): void {
        ...
        const topic = new sns.Topic(this, 'lambda-test-PipelineResultNotification', {
        ...
        const queue = new sqs.Queue(this, 'lambda-test-pipelineresults');
        ...
        //  Store BitBucket 'username' and 'app-password' in AWS SecretsManager 
        //  In the name of "lambda-test/bitbucket-app-password" 
        //  It will automatically retrieve from there

        const app_password = secretsmanager.Secret.fromSecretNameV2(this, "bitbucket-app-password", "lambda-test/bitbucket-app-password" )
        ...
        new cdk.CfnOutput( this, "sns-topic-output", {
            ...
            exportName: 'lambda-test-PipelineResultNotification'
        });
    }
